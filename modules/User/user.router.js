...
const { signup, confirmEmail, signin, profile, editProfilePic, editCoverPic, allUser, resendConfirmationEmail, loginWithGoogle, searchUser } = require("./controller/user");
